...
import { ZERO_NETWORK } from '../constants/zcash-network';
...
export type MapDispatchToProps = {|
  ...
  updateZeroNetwork: (newNetwork: string) => void,
|};
...
const mapDispatchToProps = (dispatch: Dispatch): MapDispatchToProps => ({
  ...
  updateZeroNetwork: (newNetwork) => {
    electronStore.set(ZERO_NETWORK, newNetwork);
