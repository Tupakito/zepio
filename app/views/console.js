...
import ConsoleSymbolDark from '../assets/images/zero-icon.png';
import ConsoleSymbolLight from '../assets/images/zero-icon.png';
...
class Component extends PureComponent<Props, State> {
  ...
  getLog = (state: State) => `
    ...
    In order to ensure you are adequately protecting your privacy when using Zero, please see <https://zero.directory/zero-node/>.
  ...
  render() {
    ...
    return (
      <Wrapper id='console-wrapper'>
        <Fragment>
          <ConsoleImg src={ConsoleSymbol} alt='Zerod' />
